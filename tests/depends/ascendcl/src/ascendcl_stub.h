...
class AclRuntimeStub {
 public:
  ...
  virtual aclError aclrtGetPhyDevIdByUserDevId(const int32_t userDevId, int32_t *const phyDevId);
  ...
  virtual aclError aclrtBinaryLoadFromFile(const char *modelPath, aclrtBinaryLoadOptions *options,
                                           aclrtBinHandle *binHandle);
  virtual aclError aclrtBinaryGetFunction(aclrtBinHandle binHandle, const char *functionName,
                                          aclrtFuncHandle *funcHandle);
