...
## HIXL在Ascend 950PR/Ascend 950DT上部分场景实测性能数据

### 如何读懂表格

- **Block**列：每个数据块大小（16K = 16KiB，1G = 1GiB），从16K到1G共8档。
- 各传输协议分表展示，顺序为**UB_RTP** → **UBOE**；列按方向排列：`D2rD`、`rD2D`、`D2rH`、`rH2D`、`H2rH`、`rH2H`、`H2rD`、`rD2H`。
- **UBOE**再按通道数区分：默认单通道在前，**4条通道并发**在后。
- 数值为有效带宽（GB/s）。
...
- 各传输协议分表展示，顺序为 **FabricMem** → **ROCE** → **HCCS**；列按方向排列：`D2rD`、`rD2D`、`D2rH`、`rH2D`、`H2rH`、`rH2H`、`H2rD`、`rD2H`。
- **HCCS** / **ROCE** 再按路径区分：**hixl_cs** 在前，**通信域**（默认）在后。
- **FabricMem** 再按 **AICPU展开** / **Host展开** 分表展示；其中 **Host展开** 为 **4 条流并发**。
...
| **Block** | **D2rD** | **rD2D** | **D2rH** | **rH2D** | **H2rH** | **rH2H** | **H2rD** | **rD2H** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| 16K | 18.018 | 17.208 | 不支持 | 不支持 | 不支持 | 不支持 | 9.984 | 9.376 |
| 32K | 36.710 | 34.829 | 不支持 | 不支持 | 不支持 | 不支持 | 18.236 | 16.512 |
| 64K | 70.133 | 60.441 | 不支持 | 不支持 | 不支持 | 不支持 | 31.669 | 26.223 |
| 128K | 122.422 | 88.537 | 不支持 | 不支持 | 不支持 | 不支持 | 40.774 | 35.149 |
| 256K | 156.034 | 116.639 | 不支持 | 不支持 | 不支持 | 不支持 | 48.461 | 42.922 |
| 512K | 161.101 | 136.330 | 不支持 | 不支持 | 不支持 | 不支持 | 53.868 | 48.367 |
| 1M | 161.185 | 150.467 | 不支持 | 不支持 | 不支持 | 不支持 | 57.183 | 51.890 |
| 2M | 164.610 | 165.265 | 不支持 | 不支持 | 不支持 | 不支持 | 59.791 | 54.410 |

#### HCCS（通信域）

| **Block** | **D2rD** | **rD2D** | **D2rH** | **rH2D** | **H2rH** | **rH2H** | **H2rD** | **rD2H** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| 16K | 15.983 | 15.016 | 不支持 | 不支持 | 不支持 | 不支持 | 7.180 | 7.217 |
| 32K | 31.97 | 30.106 | 不支持 | 不支持 | 不支持 | 不支持 | 13.487 | 13.343 |
| 64K | 60.293 | 52.557 | 不支持 | 不支持 | 不支持 | 不支持 | 23.636 | 22.226 |
| 128K | 108.384 | 80.165 | 不支持 | 不支持 | 不支持 | 不支持 | 29.658 | 28.408 |
| 256K | 146.208 | 110.322 | 不支持 | 不支持 | 不支持 | 不支持 | 34.267 | 33.201 |
| 512K | 158.308 | 132.348 | 不支持 | 不支持 | 不支持 | 不支持 | 37.354 | 36.511 |
| 1M | 157.44 | 143.571 | 不支持 | 不支持 | 不支持 | 不支持 | 39.000 | 38.343 |
| 2M | 158.812 | 158.189 | 不支持 | 不支持 | 不支持 | 不支持 | 40.484 | 39.856 |
...
| **Block** | **D2rD** | **rD2D** | **D2rH** | **rH2D** | **H2rH** | **rH2H** | **H2rD** | **rD2H** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| 16K | 3.471 | 5.041 | 不支持 | 不支持 | 不支持 | 不支持 | 4.002 | 4.044 |
| 32K | 6.911 | 10.09 | 不支持 | 不支持 | 不支持 | 不支持 | 7.724 | 7.692 |
| 64K | 12.967 | 18.747 | 不支持 | 不支持 | 不支持 | 不支持 | 14.429 | 13.471 |
| 128K | 22.87 | 32.633 | 不支持 | 不支持 | 不支持 | 不支持 | 16.257 | 15.859 |
| 256K | 37.465 | 53.585 | 不支持 | 不支持 | 不支持 | 不支持 | 17.464 | 17.587 |
| 512K | 54.564 | 77.99 | 不支持 | 不支持 | 不支持 | 不支持 | 18.186 | 18.576 |
| 1M | 71.708 | 98.584 | 不支持 | 不支持 | 不支持 | 不支持 | 18.519 | 18.969 |
| 2M | 89.985 | 117.531 | 不支持 | 不支持 | 不支持 | 不支持 | 18.907 | 19.287 |
...
- 总数据量：128MiB。
- **Block** 列：每个数据块大小（16K = 16 KiB，1M = 1 MiB）。
- 各传输协议分表展示，顺序为 **ROCE** → **HCCS**；列按方向排列：`D2rD`、`rD2D`、`D2rH`、`rH2D`、`H2rH`、`rH2H`、`H2rD`、`rD2H`。
- **ROCE** / **HCCS** 按路径区分：**hixl_cs** 在前，**通信域** 在后。
- 数值为有效带宽（GB/s）；**不支持** 表示该传输路径在该平台上不支持该方向；**——** 表示尚未采集到数据。
...
| **Block** | **D2rD** | **rD2D** | **D2rH** | **rH2D** | **H2rH** | **rH2H** | **H2rD** | **rD2H** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| 16K | 8.903 | 10.265 | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 |
| 32K | 12.778 | 15.453 | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 |
| 64K | 15.780 | 19.748 | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 |
| 128K | 17.787 | 22.810 | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 |
| 256K | 19.018 | 24.752 | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 |
| 512K | 19.680 | 25.752 | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 |
| 1M | 20.031 | 26.281 | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 |
| 2M | 20.284 | 26.814 | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 |

#### HCCS（通信域）

| **Block** | **D2rD** | **rD2D** | **D2rH** | **rH2D** | **H2rH** | **rH2H** | **H2rD** | **rD2H** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| 16K | 1.47 | 1.387 | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 |
| 32K | 2.493 | 2.744 | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 |
| 64K | 5.439 | 5.497 | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 |
| 128K | 6.568 | 10.991 | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 |
| 256K | 12.062 | 22.037 | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 |
| 512K | 19.571 | 26.405 | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 |
| 1M | 19.853 | 27.027 | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 |
| 2M | 20.515 | 27.345 | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 | 不支持 |
