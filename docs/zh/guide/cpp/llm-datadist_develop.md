...
请参考《[CANN软件安装](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/920beta2/softwareinst/instg/instg_0000.html?OS=openEuler&InstallType=netyum)》安装驱动固件以及CANN软件。
...
使用本文档过程中，还涉及到如下环境变量，具体请参见《[环境变量参考](https://gitcode.com/cann/docs/blob/9.2.0-beta.2/docs/zh/env-vars/README.md)》。
