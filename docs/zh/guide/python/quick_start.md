...
<!-- npu="910b" id1 -->
- Atlas A2系列产品：针对Atlas A2系列产品，仅支持Atlas 800I A2推理服务器、A200I A2 Box异构组件。该场景下Server内采用HCCS传输协议时，仅支持D2D。
<!-- end id1 -->
<!-- npu="A3" id2 -->
...
更多代码样例，请单击[Gitcode](https://gitcode.com/cann/hixl)，选择配套版本，从“examples/python”目录中获取样例。
