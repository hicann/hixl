...
如上表格中ranktable具体信息请参见[《HCCL集合通信库用户指南》](https://gitcode.com/cann/hccl/blob/9.2.0-beta.1/docs/zh/user_guide/README.md)。<br>OPTION_LOCAL_COMM_RES配置version为"1.3"时，通信资源配置字段说明请参考[HIXL接口文档](./HIXL-interface.md#通信资源配置字段说明)。
