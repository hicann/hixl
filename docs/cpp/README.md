...
- HIXL：Huawei Xfer Library
  ...
  - HIXL_CS相关接口存放在："INSTALL\_DIR/include/cs/hixl_cs.h"。INSTALL\_DIR请替换为CANN软件安装后文件存储路径。若安装的Ascend-cann-toolkit软件包，以root安装举例，则安装后文件存储路径为：/usr/local/Ascend/cann。
...
- Ascend 950PR/Ascend 950DT：超节点内支持的协议包括：UB、RoCE、UBoE，超节点间支持的协议包括：RoCE、UBoE。
...
- [HIXL_CS接口](HIXL_CS接口.md)
- [HIXL接口](HIXL接口.md)
- [HIXL数据结构](HIXL数据结构.md)
- [HIXL错误码](HIXL错误码.md)
- [不支持的接口](不支持的接口.md)
- [待废弃_ADXL接口](待废弃_ADXL接口.md)
- [待废弃_ADXL数据结构](待废弃_ADXL数据结构.md)
- [待废弃_ADXL错误码](待废弃_ADXL错误码.md)