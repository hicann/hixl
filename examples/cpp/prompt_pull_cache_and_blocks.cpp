...
int32_t RunPromptSample(const char *device_id, const char *local_ip, const std::string &transfer_backend,
...
int main(int32_t argc, char **argv) {
  ...
  auto ret = RunPromptSample(device_id, local_ip, transfer_backend, local_comm_res);
  return ret;
}
